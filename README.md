...
🚀 **Nesse momento estou:** Atualmente, foco meus estudos acadêmicos em Java e C, enquanto exploro o desenvolvimento web de forma prática com PHP, JavaScript e MySQL. Meu objetivo é unir o raciocínio estruturado do backend com a agilidade das tecnologias web.

🌍 **Idiomas e Interesses:**

* 🇬🇧 **Inglês:** Nível Intermediário Superior (B2).
* 🎲 **Fun Fact:** Entusiasta de RPG e GameDev.
